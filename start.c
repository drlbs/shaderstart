...
void drawscene(SDL_Window* & window)
{
    ...
    char vertexShaderTextFileLiteral[] = "start.vert";
    char fragmentShaderTextFileLiteral[] = "start.frag";
    ...
    printf("diamond and colors defined\n");
    ...
    printf("about to move shader programs to buffers\n");
    /* Read our shaders into the appropriate buffers */
    vertexsource = filetobuf(vertexShaderTextFileLiteral);
    fragmentsource = filetobuf(fragmentShaderTextFileLiteral);
    ...
    printf("just compiled vertexshader\n");
    glGetShaderiv(vertexshader, GL_COMPILE_STATUS, &IsCompiled_VS);
    printf("just finished glGetShaderiv\n");
    if(IsCompiled_VS == GL_FALSE)
    {
       glGetShaderiv(vertexshader, GL_INFO_LOG_LENGTH, &maxLength);
       printf("The length of the vertexshader log is %d\n", maxLength);
    ...
    printf("just compiled fragmentshader\n");
    glGetShaderiv(fragmentshader, GL_COMPILE_STATUS, &IsCompiled_FS);
    printf("just finished glGetShaderiv, IsCompiled_FS = %d\n", IsCompiled_FS);
    if(IsCompiled_FS == GL_FALSE)
    {
       glGetShaderiv(fragmentshader, GL_INFO_LOG_LENGTH, &maxLength);
       printf("The length of the fragmentshader log is %d\n", maxLength);
    ...
    printf("both shaders are apparently compiled and syntax error free\n"); 
    shaderprogram = glCreateProgram();

    printf("shaderprogram created\n"); 
    /* Attach our shaders to our program */
    glAttachShader(shaderprogram, vertexshader);
    glAttachShader(shaderprogram, fragmentshader);

    printf("shaderprograms attached\n"); 
    ...
    printf("About to load the shader into the pipeline\n");
    /* Load the shader into the rendering pipeline */
    glUseProgram(shaderprogram);

    printf("About to start GL loop pipeline\n");
    ...
    printf("pipeline should be complete\n");
